...
@patch('mercado_bitcoin.ingestors.DataIngestor.__abstractmethods__', set()) # Não precisa essa linha porque já está ali em cima do fixture.
class TestIngestors:
    ...
    @patch('builtins.open',new_callable=mock_open, read_data='2021-06-25')
    @patch('mercado_bitcoin.ingestors.DataIngestor._checkpoint_filename', return_value='mock_test.checkpoint')
